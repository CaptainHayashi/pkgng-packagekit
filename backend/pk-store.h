...
gboolean 
pk_store_set_array(PkStore * store,
    const gchar *key,
    GPtrArray * data);
gboolean 
pk_store_set_string(PkStore * store,
    const gchar *key,
    const gchar *data);
gboolean 
pk_store_set_strv(PkStore * store,
    const gchar *key,
    gchar **data);
gboolean 
pk_store_set_uint(PkStore * store,
    const gchar *key,
    guint data);
gboolean 
pk_store_set_bool(PkStore * store,
    const gchar *key,
    gboolean data);
gboolean 
pk_store_set_pointer(PkStore * store,
    const gchar *key,
    gpointer data);

const gchar    *
pk_store_get_string(const PkStore * store,
    const gchar *key);
const GPtrArray *
pk_store_get_array(const PkStore * store,
    const gchar *key);
gchar         **
pk_store_get_strv(const PkStore * store,
    const gchar *key);
guint 
pk_store_get_uint(const PkStore * store,
    const gchar *key);
gboolean 
pk_store_get_bool(const PkStore * store,
    const gchar *key);
gpointer 
pk_store_get_pointer(const PkStore * store,
    const gchar *key);
